...
function gradeExam() {
  ...
  console.log('👨‍💼 أدمن: admin@math.com / admin123');
  console.log('👨‍🏫 معلم: teacher@math.com / teacher123');
  console.log('🧑‍🎓 طالب: student@math.com / student123');
}
