  ...
  try {
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "User" (
          ...
          "name" TEXT NOT NULL, "role" "UserRole" NOT NULL DEFAULT 'STUDENT',
          "avatar" TEXT NOT NULL DEFAULT '🧑', "phone" TEXT, "bio" TEXT,
          "rating" DOUBLE PRECISION DEFAULT 0, "studentsCount" INTEGER DEFAULT 0,
          "lessonsCount" INTEGER DEFAULT 0, "totalEarnings" DOUBLE PRECISION DEFAULT 0,
          "specialties" TEXT[] DEFAULT ARRAY[]::TEXT[], "stage" TEXT, "year" TEXT,
          "subscriptionStatus" TEXT, "subscriptionExpiry" TIMESTAMP(3),
          "completedLessons" TEXT[] DEFAULT ARRAY[]::TEXT[], "favorites" TEXT[] DEFAULT ARRAY[]::TEXT[],
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Unit" (
          ...
          "order" INTEGER NOT NULL DEFAULT 1, "stageId" TEXT NOT NULL, "yearId" TEXT NOT NULL,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Lesson" (
          ...
          "teacherId" TEXT NOT NULL, "unitId" TEXT NOT NULL, "videoUrl" TEXT NOT NULL,
          "videoSource" TEXT NOT NULL, "videoDuration" TEXT NOT NULL,
          "views" INTEGER NOT NULL DEFAULT 0, "order" INTEGER NOT NULL DEFAULT 0,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "PDFFile" (
          ...
          "size" TEXT NOT NULL, "pages" INTEGER NOT NULL DEFAULT 1, "lessonId" TEXT NOT NULL,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "AdditionalFile" (
          "id" TEXT NOT NULL, "name" TEXT NOT NULL, "url" TEXT NOT NULL,
          "type" TEXT NOT NULL, "lessonId" TEXT NOT NULL,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Assignment" (
          "id" TEXT NOT NULL, "title" TEXT NOT NULL, "description" TEXT,
          "totalPoints" INTEGER NOT NULL DEFAULT 20, "dueDate" TIMESTAMP(3),
          "autoGrade" BOOLEAN NOT NULL DEFAULT true, "lessonId" TEXT,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Exam" (
          "id" TEXT NOT NULL, "title" TEXT NOT NULL, "description" TEXT,
          "durationMinutes" INTEGER NOT NULL DEFAULT 30, "preventBack" BOOLEAN NOT NULL DEFAULT true,
          "randomOrder" BOOLEAN NOT NULL DEFAULT false, "showGrade" BOOLEAN NOT NULL DEFAULT true,
          "showSolution" BOOLEAN NOT NULL DEFAULT true, "passingScore" INTEGER NOT NULL DEFAULT 60,
          "isHtmlExam" BOOLEAN NOT NULL DEFAULT false, "htmlContent" TEXT, "lessonId" TEXT,
          "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Question" (
          "id" TEXT NOT NULL, "type" "QuestionType" NOT NULL,
          "difficulty" "Difficulty" NOT NULL DEFAULT 'MEDIUM', "text" TEXT NOT NULL,
          "options" TEXT[] DEFAULT ARRAY[]::TEXT[], "correctAnswer" TEXT NOT NULL,
          "explanation" TEXT, "points" INTEGER NOT NULL DEFAULT 5, "imageUrl" TEXT,
          "stageId" TEXT, "yearId" TEXT, "unitId" TEXT, "lessonId" TEXT,
          "assignmentId" TEXT, "examId" TEXT,
          "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Comment" (
          "id" TEXT NOT NULL, "text" TEXT NOT NULL, "rating" INTEGER,
          "userId" TEXT NOT NULL, "lessonId" TEXT NOT NULL,
          "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Grade" (
          "id" TEXT NOT NULL, "score" INTEGER NOT NULL, "totalScore" INTEGER NOT NULL,
          "date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "itemType" TEXT NOT NULL,
          "itemId" TEXT NOT NULL, "title" TEXT NOT NULL, "studentId" TEXT NOT NULL,
          "studentName" TEXT NOT NULL, "assignmentId" TEXT, "examId" TEXT,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Notification" (
          ...
          "type" "NotificationType" NOT NULL DEFAULT 'INFO', "userId" TEXT,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Payment" (
          "id" TEXT NOT NULL, "amount" DOUBLE PRECISION NOT NULL,
          "subscriptionName" TEXT NOT NULL, "method" TEXT NOT NULL, "status" TEXT NOT NULL,
          "date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "couponCode" TEXT,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Invoice" (
          "id" TEXT NOT NULL, "amount" DOUBLE PRECISION NOT NULL,
          "subscriptionName" TEXT NOT NULL, "date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
          "status" TEXT NOT NULL, "studentId" TEXT NOT NULL,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Certificate" (
          "id" TEXT NOT NULL, "courseName" TEXT NOT NULL,
          "issueDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "grade" DOUBLE PRECISION NOT NULL,
          "studentId" TEXT NOT NULL, "studentName" TEXT NOT NULL,
    ...
    await executeSQL(`
      CREATE TABLE IF NOT EXISTS "Coupon" (
          "id" TEXT NOT NULL, "code" TEXT NOT NULL, "discount" DOUBLE PRECISION NOT NULL,
          "type" TEXT NOT NULL, "maxUses" INTEGER NOT NULL DEFAULT 100,
          "usedCount" INTEGER NOT NULL DEFAULT 0, "expiry" TIMESTAMP(3) NOT NULL,
